...
Agora você entende da época medieval como ninguém!
Pegue esta chave grega como recompensa para avançar."
...
func _end_game() -> void:
	...
	get_tree().change_scene_to_file("res://scene/mapa2.tscn")
