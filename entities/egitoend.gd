...
Agora você domina os mistérios do Egito Antigo como ninguém!
Você se tornou um verdadeiro expert em História!"
...
func _end_game() -> void:
	...
	get_tree().change_scene_to_file("res://scene/fim_de_jogo.tscn")
